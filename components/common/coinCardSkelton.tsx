        ...
        <div className="flex flex-col gap-6 p-4 max-w-7xl mx-auto w-full">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {skeletonItems.map((item) => (
                    <div key={item} className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm p-4 flex flex-col items-center gap-2 border border-zinc-200/80 dark:border-zinc-800 animate-pulse">
