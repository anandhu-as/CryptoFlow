...
const CoinCard = ({ coin, isWatchlisted, handleWatchList }: CoinCardProps) => {
    ...
    return (
        ...
        >
            ...
            <button
                className={`w-full mt-2 py-1.5 px-2 text-xs font-semibold rounded-xl transition-colors relative z-10 flex items-center justify-center gap-1.5 ${isWatchlisted
